...
{
    { S_PUNCH1,    250,  50, 0,   0,  1, charp"fist"           },
    { S_SG,       1400,  10, 0,   0, 20, charp"shotgun"        },  // *SGRAYS
    { S_CG,        100,  30, 0,   0,  7, charp"chaingun"       },
    { S_RLFIRE,    800, 120, 80,  0, 10, charp"rocketlauncher" },
    { S_RIFLE,    1500, 100, 0,   0, 30, charp"rifle"          },
    { S_FLAUNCH,   200,  20, 50,  4,  1, charp"fireball"       },
    { S_ICEBALL,   200,  40, 30,  6,  1, charp"iceball"        },
    { S_SLIMEBALL, 200,  30, 160, 7,  1, charp"slimeball"      },
    { S_PIGR1,     250,  50, 0,   0,  1, charp"bite"           },
};
